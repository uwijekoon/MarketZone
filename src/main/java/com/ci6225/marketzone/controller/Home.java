...
public class Home {
	...
	@RequestMapping(value = "image/{userId}/{imageName}", method = RequestMethod.GET)
	public void image(@PathVariable(value = "userId") int userId, @PathVariable(value = "imageName") String imageName, HttpServletResponse response ) throws IOException {
		String imagePath ="/Users/asankalakmal/Desktop/MarketZoneImages";
	    InputStream in = context.getResourceAsStream(imagePath + File.separator + userId + File.separator +imageName);
